...
3. **Scope and Limitations**
   ...
   3.2. **Project Scope**
   Provide a description of the software being specified and its purpose, including relevant benefits, objectives, and goals. Relate the software to corporate goals or business strategies. 
...
| **Description:**       | The Actor selects a recipe from the list of available recipes. The system displays a view of the recipe based on the actor’s level of access (role-based access control).                                                                                                                |
| **Trigger:**           | Actor opens the recipe menu section of the system.                                                                                                                                                                                                                                       |
| **Preconditions:**     | <ul><li>PRE-1: User is logged in.</li><li>PRE-2: User is authenticated.</li><li>PRE-3: Recipe exists in the system.</li></ul>                                                                                                                                                            |
| **Postconditions:**    | <ul><li>POST-1: Recipe is displayed according to the actor’s access level.</li></ul>                                                                                                                                                                                                     |
| **Normal Flow:**       | <ol><li>Actor selects the recipe menu option.</li><li>System displays a list of active and inactive recipes based on access permissions.</li><li>Actor selects a desired recipe from the list.</li><li>System displays the detailed recipe view according to the actor’s role.</li></ol> |
| **Alternate Flows:**   | <ol><li><strong>2.1 View Limited Recipe</strong><ol type="a"><li>Front of House Staff selects the recipe menu option.</li><li>Selects a recipe from the list.</li><li>System displays a limited recipe view (e.g., ingredients and allergens only).</li></ol></li></ol>                  |
| **Exceptions:**        | <ul><li>EX-1: If the recipe fails to load due to a system error or timeout, the system displays an error message and logs the event.</li><li>EX-2: If the user does not have sufficient permissions, the system displays an access denied message.</li></ul>                             |
| **Priority:**          | High                                                                                                                                                                                                                                                                                     |
| **Frequency of Use:**  | 10 times per day by Kitchen Staff, 1 time per day by Manager, 20 times per day by Front of House Staff                                                                                                                                                                                   |
| **Business Rules:**    | <ul><li>BR-1: The system must clearly display allergen information for all recipes.</li><li>BR-2: Only authorized ingredients may be included in recipes.</li></ul>                                                                                                                      |
...
- As a fundraiser, I want to create visually appealing campaign pages to attract more donors.
